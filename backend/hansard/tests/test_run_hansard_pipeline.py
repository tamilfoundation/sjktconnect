...
class RunHansardPipelineTests(TestCase):
    ...
    @patch(f"{CMD}.generate_all_pending_reports")
    ...
    def test_all_steps_called_in_order(
        ...
        mock_reports.return_value = {"generated": 1}

        out, _ = self._call()

        mock_sync.assert_called_once()
        mock_call_cmd.assert_called_once_with(
    ...
    def test_step_failure_continues(
        ...
        mock_reports.return_value = {"generated": 0}
