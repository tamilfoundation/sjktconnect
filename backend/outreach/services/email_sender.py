...
def _build_outreach_html(school: School, school_url: str, claim_url: str) -> str:
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <strong>{school_name}</strong> on <strong>SJK(T) Connect</strong> — Malaysia's
        ...
        <ul>
            ...
            <li>Parliament Watch — tracking how your MP speaks about Tamil schools</li>
        </ul>
        ...
        <p style="color: #999; font-size: 12px;">
            SJK(T) Connect — Tamil School Intelligence &amp; Advocacy Platform<br>
