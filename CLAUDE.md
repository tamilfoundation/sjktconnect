...
**Sprint 22 — SEO Snippet & Canonical Hostname Fix** — ✅ Done 2026-05-01. Triggered by GSC export showing avg position flatlined at 7.4 with 30× impressions growth (0 → 33.1k over 3 months). Investigation found three layered issues: (a) English/Tamil locale meta descriptions were generic prose so Google's snippet picker pulled junk; (b) schools without uploaded photos rendered text-only "No photo" placeholder, giving Google nothing to thumbnail; (c) www and root hostnames both serve 200, splitting ranking signal. Sprint 22 ships fixes (a) and (b) in code; (c) is a Cloudflare Page Rule pending user action.
