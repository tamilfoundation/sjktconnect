...
- 2026-07-23 fix(newswatch): Bhg/Bahagian/Div/Division bridge moved into the match-time variant generator — "Div 4" resolved to nothing (backend: news_analyser, seed_aliases, +5 tests). **Third patch to the same Ladang Labu / school-matching surface (Sprint 27 #2, Sprint 28.1, this) — cluster candidate for the next Consolidation Review**
