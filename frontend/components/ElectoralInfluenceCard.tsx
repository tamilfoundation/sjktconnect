        ...
        {(constituencyCode || constituencyName) && (
          <div className="flex items-center justify-center gap-3 mt-4 text-[11px]">
            {constituencyCode && constituencyName && state && (
              <a
                href={`https://open.dosm.gov.my/dashboard/kawasanku/${encodeURIComponent(state.charAt(0).toUpperCase() + state.slice(1).toLowerCase())}/parlimen/${encodeURIComponent(constituencyCode + " " + constituencyName)}`}
                target="_blank"
